...
## Project Structure
    ...
    ├── testapiautoteammemb_78083  # Django project configurations
...
1. Clone this repo and `cd testapiautoteammemb_78083`
...
2. Clone this repo and `cd testapiautoteammemb_78083`
